 ...
 * 	found.
 */
static void *(*bpf_map_lookup_elem)(void *map, const void *key) = reinterpret_cast<void *(*)(void *, const void *)>(1);
 ...
 * 	in case of failure.
 */
static long (*bpf_trace_printk)(const char *fmt, __u32 fmt_size, ...) = reinterpret_cast<long (*)(const char *, __u32, ...)>(6);
 ...
 * 	*current_task*\ **->pid**.
 */
static __u64 (*bpf_get_current_pid_tgid)(void) = reinterpret_cast<__u64 (*)(void)>(14);
